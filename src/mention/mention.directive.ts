import {Directive, ElementRef, Input, ComponentFactoryResolver, ViewContainerRef, HostListener} from '@angular/core';
...
export class MentionDirective {
  ...
  @HostListener('keydown', ['$event']) keyHandler(event: any,
